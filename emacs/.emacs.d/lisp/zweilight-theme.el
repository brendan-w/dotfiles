...
;;;;; font lock
   ...
   `(font-lock-type-face ((t (:foreground ,void-blue))))
   `(font-lock-variable-name-face ((t (:foreground ,void-fg))))
...
;;;;; helm
   ...
   `(helm-ff-invalid-symlink ((t (:foreground ,void-pink :background ,void-bg :weight bold))))
   `(helm-ff-symlink ((t (:foreground ,void-cyan :background ,void-bg :weight bold))))
...
;;;;; whitespace-mode
   ...
   `(whitespace-indentation ((t (:background ,void-cyan :foreground ,void-pink))))
   `(whitespace-empty ((t (:background ,void-cyan))))
   `(whitespace-space-after-tab ((t (:background ,void-cyan :foreground ,void-pink))))
;;;;; wanderlust
